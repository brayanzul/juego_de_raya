...
import 'package:juego_de_raya/ui/theme/color.dart';
import 'package:juego_de_raya/utils/game_logic.dart';
...
class _GameScreenState extends State<GameScreen> {
  ...
  String result = "";
  List<int> scoreboard = [0,0,0,0,0,0,0,0]; // the score are for the different combination of the game [Row1,2,3, Coli1,2,3, Diagonal1,2]
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: MainColor.seconddaryColor,
